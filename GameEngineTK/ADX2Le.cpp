...
ADX2Le_Player			ADX2Le::m_playerBgm;			// プレイヤー(Bgm)
ADX2Le_Player			ADX2Le::m_playerSe;				// プレイヤー(Se)
...
// プレイヤーの取得関数
//--------------------------------------------------------------------------------------
ADX2Le_Player* ADX2Le::GetPlayerBgm()
{
	return &m_playerBgm;
}
...
// プレイヤーの取得関数
//--------------------------------------------------------------------------------------
ADX2Le_Player* ADX2Le::GetPlayerSe()
{
	return &m_playerSe;
}
...
{
	m_playerBgm.LoadAcb(acb, awb);
	m_playerSe.LoadAcb(acb, awb);
}

//--------------------------------------------------------------------------------------
// 指定キューの再生 
//--------------------------------------------------------------------------------------
CriAtomExPlaybackId ADX2Le::PlayBgm(CriAtomExCueId cue_id, float volume)
{
	return m_playerBgm.Play(cue_id, volume);
}

//--------------------------------------------------------------------------------------
// プレイヤーの音量の設定
//--------------------------------------------------------------------------------------
void ADX2Le::SetVolumeBgm(float volume)
{
	m_playerBgm.SetVolume(volume);
}

//--------------------------------------------------------------------------------------
// プレイヤーのポーズ
//--------------------------------------------------------------------------------------
void ADX2Le::PauseBgm()
{
	m_playerBgm.Pause();
}
...
// プレイヤーのポーズ状態の取得
//--------------------------------------------------------------------------------------
bool ADX2Le::IsPauseBgm()
{
	return m_playerBgm.IsPause();
}
...
// 指定キューの再生 
//--------------------------------------------------------------------------------------
CriAtomExPlaybackId ADX2Le::PlaySe(CriAtomExCueId cue_id, float volume)
{
	return m_playerSe.Play(cue_id, volume);
}

//--------------------------------------------------------------------------------------
// プレイヤーの音量の設定
//--------------------------------------------------------------------------------------
void ADX2Le::SetVolumeSe(float volume)
{
	m_playerSe.SetVolume(volume);
}
...
// プレイヤーのポーズ状態の取得
//--------------------------------------------------------------------------------------
bool ADX2Le::IsPauseSe()
{
	return m_playerSe.IsPause();
}
